...
export function AnimatedCard() {
  return (
    <Card className="absolute top-4 left-4">
      ...
      <CardDescription>
        This product was created with the above technologies
      </CardDescription>
    </Card>
  );
}
    ...
    <div className="p-8 overflow-hidden h-full relative flex items-center justify-center">
      <div className="flex flex-row flex-shrink-0 justify-center items-center gap-2">
        ...
        <Container className="circle-3">
          <SiTailwindcss className="h-6 w-6 text-blue-500" />
        </Container>
      </div>
...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "max-w-sm w-full mx-auto p-8 rounded-xl border border-[rgba(255,255,255,0.10)] dark:bg-[rgba(40,40,40,0.70)] bg-dark-100 shadow-[2px_4px_16px_0px_rgba(248,248,248,0.06)_inset] group",
        className
      )}
    >
      {children}
...
export const CardTitle = ({
  ...
  return (
    <h3 className={cn("text-lg font-semibold text-lime-400 py-2", className)}>
      {children}
    </h3>
  );
};
...
export const CardDescription = ({
  ...
  return (
    <p className={cn("text-sm font-normal text-light-700 max-w-sm", className)}>
      {children}
    </p>
  );
};
